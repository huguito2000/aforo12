...
WebUI.callTestCase(findTestCase('reclutador/crear vacante/3.- vacante1'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('reclutador/crear vacantes/vacante2'))
