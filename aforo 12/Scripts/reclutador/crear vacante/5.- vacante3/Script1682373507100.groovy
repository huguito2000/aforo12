...
WebUI.callTestCase(findTestCase('reclutador/crear vacante/4.- vacante2'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('reclutador/crear vacantes/vacante3'))
