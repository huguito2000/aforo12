...
WebUI.callTestCase(findTestCase('reclutador/crear vacante/7.- vacante5'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('reclutador/crear vacantes/vacante6'))
