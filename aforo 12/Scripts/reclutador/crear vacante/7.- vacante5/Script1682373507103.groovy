...
WebUI.callTestCase(findTestCase('reclutador/crear vacante/6.- vacante4'), [:], FailureHandling.STOP_ON_FAILURE)

response = WS.sendRequest(findTestObject('reclutador/crear vacantes/vacante5'))
